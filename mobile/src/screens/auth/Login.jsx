...
export const Login = () => {
    ...
    return (
        <View style={tw`h-full justify-center items-center p-8`}>
            ...
            <Pressable onPress={handleNavigateLogin} style={tw`absolute px-2 pb-1 top-12 left-8 border-b-2 border-white flex-row gap-2 items-center`}>
                <Key style={tw`text-white`} size={20}/>
                <Text style={tw`text-white text-lg font-bold`}>Register</Text>
            </Pressable>

            <View style={tw`mb-12 items-center`}>
                <Text style={tw`text-white text-3xl font-bold`}>Login</Text>
