...
function App() {
  ...
  if (loading) return (
    <div className="flex items-center justify-center h-screen">
      ...
      <div role="status">
        <svg aria-hidden="true" className="w-24 h-24 text-gray-50 animate-spin dark:text-teal-600 fill-teal-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
