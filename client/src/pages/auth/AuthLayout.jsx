...
const Seperator = () => {
    return (
        <div className='h-full flex items-center absolute left-1/2 -translate-x-2/3'>
...
export default function AuthLayout() {
    return (
        <div className='min-h-screen w-full flex justify-center items-center flex-col layout-container relative'>
            <div className='flex bg-white relative w-1/2 rounded-md overflow-hidden shadow-2xl h-[32rem]'>
